...
vehicle = Vehicle("Tayota", 2018)
vehicle.get_info()
car = Car("glanza",2020,5)
car.get_info()
motorcycle = Motorcycle("pulsor", 2014,True)
motorcycle.get_info()
...
manager = Manager("satish", 65000, "production")
manager.get_details() 
developer = Developer("swapna", 70000, "Python-developer")
...
book = Book("THE PRETTY GIRL IS ALWAYS RIGHT", "TWO STATES", 4)
dvd = DVD("KALKI", "NAG ASHWIN", "175 min")
